...
class Class_model extends MY_Model {
    ...
    public function getClassTeacher() {
        $query = $this->db->query('SELECT class_teacher.*,class.classes,streams.stream FROM `class_teacher` INNER JOIN class on class.classesID=class_teacher.class_id INNER JOIN streams on streams.Streamid=class_teacher.section_id where class_teacher.session_id="' . $this->current_session . '" GROUP BY class_teacher.class_id , class_teacher.section_id ORDER by length(class.classes), class.classes');
    ...
    public function getSelectedClass($id){

        $classquery = $this->db->get_where('class',['classesID' => $id]);
    ...
    public function getSelectedStream($id){

        $classquery = $this->db->get_where('streams',['Streamid' => $id]);

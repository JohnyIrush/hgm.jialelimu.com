...
class Subject_model extends MY_Model {
    ...
    function check_code_exists($data) {
        ...
        /*Get Subjects and respective teacher*/
        public function getSubjectTeachers(){

            $this->db->select('*');
            $this->db->from('subjects');
            $this->db->join('teacher_subjects','teacher_subjects.subject_id = subjects.id');
            $this->db->join('staff','teacher_subjects.teacher_id = staff.id');
            $teachersubjects = $this->db->get();

            return $teachersubjects->result();

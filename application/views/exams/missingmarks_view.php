                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>View Exam Entered</li>
                        </ul>
                        <h4>View Exam Entered</h4>
                    </div>
                </div><!-- media -->
            </div><!-- pageheader -->
            ...
            <div class="contentpanel">
                ...
                <div class="row" style="background:url('images/back.png');">
                   <div class="col-md-3">
                    ...
                    <!--edit school-->
                    <div class="col-md-6">
                        <form id="" action="getexamreport.php" method="get">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">View Exam Entered Report</h4>
                            </div><!-- panel-heading -->
                            ...
                            <div class="panel-footer">
                              <div class="row">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="/exams/missingmarksreport" class="btn btn-info" role="button">Get Report</a>

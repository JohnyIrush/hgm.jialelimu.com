                ...
                <div class="row" style="background:url('images/back.png');">
                   ...
                   <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="/exams/creategrade" method="post" >
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Add New Grade</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="name" class="form-control" id="gradename" placeholder="e.g. A" maxlength="2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="points" class="form-control" id="points" placeholder="e.g. 12" maxlength="2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="marks" class="form-control" id="points" placeholder="e.g. 12" maxlength="2">
                            ...
                            <div class="panel-footer">
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-9 col-sm-offset-3">                                            
                                    ...
                                    <button class="btn btn-primary mr5" id="btnaddexam">Add Grade</button>

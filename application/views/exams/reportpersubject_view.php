                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li>Report Per Subject</li>
                        </ul>
                        <h4>Report Per Subject</h4>
                    </div>
                </div><!-- media -->
            </div><!-- pageheader -->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Report Per Subject</h4>
                            </div><!-- panel-heading -->
                            ...
                            <div class="panel-footer">
                              ...
                              <div id="addmrkscomm" style="text-align:center"></div>
                                <div class="col-sm-9 col-sm-offset-3">
                                    ...
                                    <a href="/exams/generatereportpersubject" role="button" class="btn btn-primary mr5" id="btnaddmarks">Get Report </a>

...
<script>
    ...
    checksidebar();
       ...
       <div class="wrapper secondary-bg-color">
            ...
            <header class="main-header" id="alert">
                ...
                <a href="<?php echo base_url(); ?>admin/admin/dashboard" class="logo">
                    ...
                    <span class="logo-mini img-fluid text-center"><img src="<?php echo base_url(); ?>backend/images/global/logo.png<?php; ?>" alt="<?php echo $this->customlib->getAppName() ?>" /></span>

                    <span class="logo-lg img img-fluid text-center"><img src="<?php echo base_url(); ?>backend/images/global/logo.png<?php; ?>" alt="<?php echo $this->customlib->getAppName() ?>" /></span>

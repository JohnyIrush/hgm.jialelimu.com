...
class Smsconfig extends Admin_Controller
{
    ...
    public function vonagesend(){

        //require_once 'vendor/autoload.php'; 
        require_once(dirname(__FILE__) .'/../vendor/autoload.php');
        //require_once(dirname(__FILE__) .'/tcpdf/config/eng.php');

        $basic  = new \Vonage\Client\Credentials\Basic("a1c9b832", "2ZpuN5Yk545QnjuZ");
        $client = new \Vonage\Client($basic);

        $response = $client->sms()->send(
            new \Vonage\SMS\Message\SMS("254748607169", 'SoftwaresCares', 'PCEA LIMURU BOYS Student Results sms test')
        );

...

{
    ...
    /*Student Module Actions are Defined here, this is a very big class*/
...

    {
        ...
        $studentsquery = $this->db->get('student');

        if ($studentsquery) {
            $data['nostudents'] = $studentsquery->num_rows();
        }

        $parentsquery = $this->db->get('parents');
        
        if ($parentsquery) {
            $data['noparents'] = $studentsquery->num_rows();
        }

        $teachersquery = $this->db->get_where('staff_roles',['role_id' => 2]);
        
        if ($teachersquery) {
            $data['noteachers'] = $teachersquery->num_rows();
        }

        $booksquery = $this->db->get('books');
        
        if ($booksquery) {
            $data['nobooks'] = $booksquery->num_rows();
        }
   ...
   /*Change student profile photo*/
       ...
       public function changestudentavatar(){
            ...
            $this->load->view('student/Studentinfo/changestudentavatar_view');
   ...
   public function deactivatestudent(){
        ...
        $this->load->view('student/Studentinfo/deactivatestudent_view');
  ...
  /*Reactivate Student*/
   ...
   public function reactivatestudent(){
        ...
        $this->load->view('student/Studentinfo/reactivatestudent_view');
  ...
  /*Add gurdian*/
   ...
   public function addgurdian(){
        ...
        $this->load->view('student/Studentinfo/addgurdian_form_view');
 ...
 //School settings
    ...
    public function schoolsettings(){
        ...
        $query = $this->db->get('schoolsettings');
        ...
        $this->load->view('student/Schoolsettings/schoolsettings_view',$result);
...
public function updateschoolsettings(){
    ...
    $this->db->update('schoolsettings',$details); //Update new record



    redirect('/school/schoolsettings'); 
...
public function termconfiguration(){
            ...
            $config["base_url"] = base_url() . "term/termconfiguration";

    

            $config["total_rows"] = $this->Global_model->record_count('terms');
            ...
            $result['data'] = $this->Global_model->get_records('terms');
            ...
            $this->load->view('student/Termconfiguration/termconfiguration_view',$result);
...
public function editterm(){
    ...
    $result['data'] = $this->Global_model->get_record('terms',$this->uri->segment(3));
    ...
    $this->load->view('student/Termconfiguration/editterm_view',$result);
...
public function addterm(){
    ...
    $this->Global_model->insert_record('terms',$details);



    redirect('/term/termconfiguration', 'refresh');
...
public function updateterm(){
    ...
    $this->Global_model->update_record('terms',$details,$this->input->post("id"));
...
public function manageclass(){
    ...
    $this->load->view('student/Manageclass/manageclass_view',$result);
...
public function addclass(){
    ...
    $this->load->view('student/Manageclass/addclass_view');
...
public function editclass(){
    ...
    $classesquery = $this->db->get_where('class',['classesID' => $this->uri->segment(3)]);
    $result['classes'] = $classesquery->result();
    ...
    $this->load->view('student/Manageclass/editclass_view', $result);
...
public function updateclass(){
    ...
    $this->db->update('class',$details);

    redirect('/class/manageclass');
...
public function managestream(){
    ...
    $this->load->view('student/Managestream/managestream_view', $result);
...
public function addstream(){
    ...
    $this->load->view('student/Managestream/addstream_view',$result);
...
public function createstream(){
    ...
    $this->db->insert('streams',$details);

    redirect('/stream/managestream');
...
public function editstream(){
    ...
    $streamquery = $this->db->get_where('streams',['Streamid' => $this->uri->segment(3)]);
    $result['streams'] = $streamquery->result();
    ...
    $this->load->view('student/Managestream/editstream_view', $result);
...
public function updatestream(){
    ...
    $this->db->update('streams',$details);
...
public function enrollmentbygender(){
    ...
    $streams = $this->Global_model->get_records('streams');
    ...
    foreach ($streams as $stream) {
        ...
        $genders .= [
            ...
            'male' => $this->Global_model->count_records('student',['Streamid'=>$stream->id,'Gender'=>'Male']),

            'female' => $this->Global_model->count_records('student',['Streamid'=>$stream->id,'Gender'=>'Female']),
    ...
    $this->load->view('student/Enrollment/enrollmentbyage_view', $genders);
...
public function managegrades(){
    ...
    $this->load->view('exams/managegrades_view');
    ...
    public function createparent(){
        ...
        $details = [
            ...
            "idpassno" => $this->input->post("idpassno"),
        ...
        $this->db->insert("parents", $details);
...
public function updateparent(){
    ...
    $this->Global_model->update_record('parents',$details,$this->input->post("id"));
    ...
    public function deleteparent(){
        ...
        $this->Global_model->delete_record($this->uri->segment(3),'parents');
    ...
    public function generateclasslist(){
        ...
        $this->load->view('student/Classlist/generateclasslist_view');
    ...
    public function classlist(){
        ...
        if ($this->input->post("all")==1) {
            ...
            $query = $this->db->get_where('student', array('Classid' => $id,'Streamid' => $streamid));  
        ...
        $this->load->view('student/Classlist/classlist_view',$result);
